...
export const useLanguageActions = () => ({
  addLanguage: useLanguageStore((state) => state.addLanguage),
  updateLanguage: useLanguageStore((state) => state.updateLanguage),
  removeLanguage: useLanguageStore((state) => state.removeLanguage),
})
